...
def store_translation(t : Translation):
...
def find_translation(t_id:int):
    ...
    if translation is None:
        translation = "Processing chack back later..."
